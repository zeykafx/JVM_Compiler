...
public class Parser {
	...
	public Program parseProgram() throws Exception {
		...
		ArrayList<VariableDeclaration> globalVariables = parseGlobalDeclarations();
	...
	public ArrayList<VariableDeclaration> parseConstants() throws Exception {
		...
		while (lookAheadSymbol.type == TokenTypes.FINAL) {
			...
			VariableDeclaration constant = parseVariableDeclaration(true, false, null);
			constants.add(constant);
		}
		return constants;
	}

	public ArrayList<VariableDeclaration> parseGlobalDeclarations() throws Exception {
		...
		while (lookAheadSymbol.type == TokenTypes.IDENTIFIER) {
			...
			VariableDeclaration variable = parseVariableDeclaration(false, false, null);
			globalVariables.add(variable);
		}
		return globalVariables;
	}

	public VariableDeclaration parseVariableDeclaration(boolean isConstant, boolean skipIdent, Symbol identIfSkipped) throws Exception {
		Symbol identifier;
	...
	public Access parseAccess() throws Exception {
		...
		while (lookAheadSymbol.type == TokenTypes.LEFT_SQUARE_BRACKET ||
